...
if camera_movement_enabled
{
    ...
    __info = scene_add_action(__info, cutscene_instance_create_at_object, player, actor_puppet, "camtarget");
    ...
    __info = scene_add_action(__info, cutscene_wait_cam_on_target_x, true);
