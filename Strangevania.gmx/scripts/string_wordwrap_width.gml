/// string_wordwrap_width(string,width,break,split,scale)
//
...
{
    var pos_space, pos_current, text_current, text_output, scale;
    pos_space = -1;
    pos_current = 1;
    ...
    while (string_length(text_current) >= pos_current) {
        if (string_width(string_copy(text_current,1,pos_current))*scale > argument1) {
